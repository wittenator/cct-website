...
$(document).ready(function () {
    ...
    window.addEventListener('resize', function () {
        // timeout wird gesetzt, damit die funktion nicht unn�tig h�ufig aufgerufen wird
        if (main.timeout) {
...
// Funktion, die je nach Bildschirmbreite entweder das Video l�dt oder nur 
// ein Bild anzeigt
function handle_home() {
    if (window.innerWidth < 1133) {
        ...
        html.push('			<img src="images/logo.png"/>');
        html.push('			<h2 class="text-white">Studentische IT-Lösungen - Made in Berlin</h2>');
        html.push('		</div>');
        html.push('	</div>');
